...
- **Core Capabilities**:
  ...
  - Monitoring dashboard and usage streaming: Streaming usage event collection over the CPA RESP protocol; supports a 15m sliding live window, multiple preset periods, and custom closed or open-ended calendar ranges;
