...
function ensureMonacoConfigured() {
  ...
  monaco.editor.defineTheme('omc-dark', {
    ...
    colors: {
      ...
      'editorLineNumber.activeForeground': '#fdfcfc',
      'editor.lineHighlightBackground': '#282424',
      'editor.selectionBackground': '#46434380',
      'editorCursor.foreground': '#fdfcfc',
      'editorWhitespace.foreground': '#464343',
      'editorIndentGuide.background': '#2e2a2a',
      ...
      'input.background': '#201d1d',
      'input.border': '#464343',
      'input.foreground': '#fdfcfc',
      'minimap.background': '#201d1d',
      'minimapSlider.background': '#6e6e7340',
      'minimapSlider.hoverBackground': '#9a989860',
      'minimapSlider.activeBackground': '#c8c6c480',
      'scrollbarSlider.background': '#6e6e7340',
      'scrollbarSlider.hoverBackground': '#9a989860',
      'scrollbarSlider.activeBackground': '#c8c6c480',
  ...
  monaco.editor.defineTheme('omc-light', {
    ...
    colors: {
      ...
      'editor.foreground': '#201d1d',
      'editorLineNumber.foreground': '#9a9898',
      'editorLineNumber.activeForeground': '#201d1d',
      'editor.lineHighlightBackground': '#f1eeee',
      'editor.selectionBackground': '#d0cece80',
      'editorCursor.foreground': '#201d1d',
      'editorWhitespace.foreground': '#e1dede',
      'editorIndentGuide.background': '#f1eeee',
      'editorIndentGuide.activeBackground': '#d0cece',
      'editorGutter.background': '#fdfcfc',
      'editorWidget.background': '#f1eeee',
      'editorWidget.border': 'rgba(15, 0, 0, 0.12)',
      'input.background': '#fdfcfc',
      'input.border': 'rgba(15, 0, 0, 0.12)',
      'input.foreground': '#201d1d',
      'minimap.background': '#fdfcfc',
      'minimapSlider.background': '#9a989840',
      'minimapSlider.hoverBackground': '#6e6e7360',
      'minimapSlider.activeBackground': '#42424580',
      'scrollbarSlider.background': '#9a989840',
      'scrollbarSlider.hoverBackground': '#6e6e7360',
      'scrollbarSlider.activeBackground': '#42424580',
      'editorOverviewRuler.border': '#00000000',
    },
  });
}
